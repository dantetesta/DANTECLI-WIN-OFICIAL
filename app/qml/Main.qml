...
ApplicationWindow {
    ...
    property string credEmoji: "🔐"
    readonly property var emojiChoices: ["🔐", "🔑", "🗝️", "🛡️", "🔒", "🌐", "🐬", "📦", "⚙️", "🚀"]
    readonly property var credTypes: ["SSH", "FTP", "SFTP", "MySQL", "API Key", "Custom"]

    // ===== dados =====
    ListModel { id: favModel
        ListElement { title: "Produção"; detail: "https://app.producao.com" }
        ListElement { title: "Servidor VPS"; detail: "root@189.45.10.2" } }
    ...
    ListModel { id: keyModel
        ...
        Component.onCompleted: {
            append({ name: "Cliente A — VPS", type: "SSH", emoji: "🔐", notes: "",
            ...
            append({ name: "OpenAI", type: "API Key", emoji: "🤖", notes: "",
                fields: [ {key:"api_key",value:"sk-proj-xxxx",secret:true} ] })
        } }
    ListModel { id: dlgFields }
    ListModel { id: sessionsModel; Component.onCompleted: append({}) }
    ...
    function openCred(idx) {
        win.credIndex = idx
        if (idx < 0) { credNameField.text = ""; credNotesField.text = ""; win.credEmoji = "🔐"; credTypeSel.value = "SSH"; loadFields(defaultFields("SSH")) }
        else { var c = keyModel.get(idx); credNameField.text = c.name; credNotesField.text = c.notes; win.credEmoji = c.emoji; credTypeSel.value = c.type; loadFields(c.fields) }
        credDialog.open()
    }
    function saveCred() {
        ...
        var obj = { name: credNameField.text, type: credTypeSel.value, emoji: win.credEmoji, notes: credNotesField.text, fields: arr }
    ...
    function applyGrid(c, r) {
        ...
        var target = c * r
        while (sessionsModel.count < target) sessionsModel.append({})
        while (sessionsModel.count > target) sessionsModel.remove(sessionsModel.count - 1)
        win.splitMode = true
        if (win.curTerm >= sessionsModel.count) win.curTerm = sessionsModel.count - 1
    }
    function addTerm() { sessionsModel.append({}); win.curTerm = sessionsModel.count - 1 }
    ...
    component TBtn: Rectangle {
        id: tb; property string glyph: ""; property string label: ""; property color tint: win.cText
        signal clicked()
    ...
    component CrudList: ColumnLayout {
        id: cl; property var lm; property string title: ""; property string glyph: "★"; property color glyphColor: "#F0C24A"
        spacing: 0
        ...
        ListView { Layout.fillWidth: true; Layout.fillHeight: true; clip: true; model: cl.lm
            delegate: Rectangle {
                ...
                RowLayout { anchors.fill: parent; anchors.leftMargin: 14; anchors.rightMargin: 8; spacing: 9
                    Text { text: cl.glyph; color: cl.glyphColor; font.pixelSize: 15 }
                    ...
                    Rectangle { implicitWidth: 24; implicitHeight: 24; radius: 6; color: edm.containsMouse ? "#2A2A36" : "transparent"
                        Text { anchors.centerIn: parent; text: "✎"; color: edm.containsMouse ? cAccent : cDim; font.pixelSize: 13 }
                    ...
                    Rectangle { implicitWidth: 24; implicitHeight: 24; radius: 6; color: dlm.containsMouse ? "#43232A" : "transparent"
                        Text { anchors.centerIn: parent; text: "✕"; color: dlm.containsMouse ? "#FF6A78" : cDim; font.pixelSize: 13 }
    ...
    component TermView: Rectangle {
        ...
        radius: 10; color: cTermBg; border.color: (ctrl && win.focusedTerm === ctrl) ? cAccent : "#2A3550"; border.width: 1.5; clip: true
        ColumnLayout { anchors.fill: parent; spacing: 0
            Rectangle { Layout.fillWidth: true; height: 34; radius: 9
            ...
            Rectangle { Layout.fillWidth: true; height: 36; color: "#0C0C0F"
                RowLayout { anchors.fill: parent; anchors.leftMargin: 12; anchors.rightMargin: 10; spacing: 6
                    ...
                    TextField { Layout.fillWidth: true; placeholderText: "comando + Enter"; color: cText; placeholderTextColor: "#5A5A64"
        ...
        Rectangle {
            ...
            ColumnLayout { anchors.fill: parent; spacing: 0
                RowLayout { Layout.fillWidth: true; Layout.margins: 10; spacing: 6
                    Repeater {
                        model: [ {ic:"★",tx:"Favoritos"},{ic:"🗂",tx:"Pastas"},{ic:"❮❯",tx:"Snippets"},{ic:"🔑",tx:"Chaves"} ]
                        delegate: Rectangle {
                            ...
                            Column { anchors.centerIn: parent; spacing: 3
                                Text { anchors.horizontalCenter: parent.horizontalCenter; text: modelData.ic; font.pixelSize: 16; color: win.sideMode === index ? "white" : cDim }
                ...
                Item { Layout.fillWidth: true; Layout.fillHeight: true
                    CrudList { anchors.fill: parent; visible: win.sideMode === 0; lm: favModel; title: "Favoritos"; glyph: "★"; glyphColor: "#F0C24A" }
                    ColumnLayout { anchors.fill: parent; visible: win.sideMode === 1; spacing: 0
                        ...
                        ListView { id: tree; Layout.fillWidth: true; Layout.fillHeight: true; Layout.topMargin: 6; clip: true; model: filesModel
                            ...
                            delegate: Rectangle {
                                ...
                                required property bool open; required property int depth
                                ...
                                MouseArea { id: fma; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                    onClicked: win.toggleRow(index) } } }
                    }
                    CrudList { anchors.fill: parent; visible: win.sideMode === 2; lm: snipModel; title: "Snippets"; glyph: "❮❯"; glyphColor: "#8FE08A" }
                    ColumnLayout { anchors.fill: parent; visible: win.sideMode === 3; spacing: 0
                        ...
                        ListView { Layout.fillWidth: true; Layout.fillHeight: true; clip: true; model: keyModel
                            delegate: Rectangle {
                                required property int index; required property string name; required property string type; required property string emoji
                                ...
                                RowLayout { anchors.fill: parent; anchors.leftMargin: 14; anchors.rightMargin: 8; spacing: 9
                                    Text { text: emoji; font.pixelSize: 17 }
                                    ColumnLayout { spacing: 1; Layout.fillWidth: true
                                    ...
                                    Rectangle { implicitWidth: 24; implicitHeight: 24; radius: 6; color: kedm.containsMouse ? "#2A2A36" : "transparent"
                                        Text { anchors.centerIn: parent; text: "✎"; color: kedm.containsMouse ? cAccent : cDim; font.pixelSize: 13 }
                                    ...
                                    Rectangle { implicitWidth: 24; implicitHeight: 24; radius: 6; color: kdlm.containsMouse ? "#43232A" : "transparent"
                                        Text { anchors.centerIn: parent; text: "✕"; color: kdlm.containsMouse ? "#FF6A78" : cDim; font.pixelSize: 13 }
        ...
        ColumnLayout {
            ...
            Rectangle { Layout.fillWidth: true; height: 52; color: cPanel
                RowLayout { anchors.fill: parent; anchors.leftMargin: 16; anchors.rightMargin: 12; spacing: 8
                    ...
                    TBtn { glyph: "🎤" }
                    TBtn { glyph: "✕"; label: "Limpar"; tint: "#E86A78"; onClicked: if (win.focusedTerm) win.focusedTerm.clearOutput() }
                    TBtn { glyph: "▦"; label: "Split Layout"; onClicked: splitPopup.open() }
                    TBtn { glyph: "⎋"; label: "Sair do Split"; tint: "#FF5A6E"; visible: win.splitMode; onClicked: win.splitMode = false }
            ...
            // ===== TERMINAIS: abas OU grid (Split) =====
            Item {
                Layout.fillWidth: true; Layout.fillHeight: true

                // --- MODO ABAS ---
                ColumnLayout {
                    anchors.fill: parent; visible: !win.splitMode; spacing: 0
                        ...
                        RowLayout { anchors.fill: parent; anchors.leftMargin: 12; spacing: 6
                            Repeater { model: sessionsModel
                                delegate: Rectangle {
                                    ...
                                    border.color: win.curTerm === index ? cAccent : "transparent"; border.width: 1
                                    MouseArea { id: tbm; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: win.curTerm = index }
                                    Row { id: trow; anchors.centerIn: parent; spacing: 7
                                        ...
                                        Rectangle { width: 18; height: 18; radius: 4; color: xma.containsMouse ? "#43232A" : "transparent"; anchors.verticalCenter: parent.verticalCenter; visible: sessionsModel.count > 1
                                            Text { anchors.centerIn: parent; text: "✕"; color: xma.containsMouse ? "#FF6A78" : cDim; font.pixelSize: 11 }
                                            MouseArea { id: xma; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: win.closeTerm(index) } }
                                    }
                                }
                            }
                            TBtn { glyph: "➕"; tint: cDim; onClicked: win.addTerm() }
                            Item { Layout.fillWidth: true }
                        }
                    }
                    TermView { Layout.fillWidth: true; Layout.fillHeight: true; Layout.margins: 10
                ...
                GridLayout {
                    ...
                    Repeater { model: sessionsModel
                        delegate: TermView { required property int index; Layout.fillWidth: true; Layout.fillHeight: true
                            ctrl: terms.objectAt(index); title: "Terminal " + (index + 1) } }
                }
            }
        }
    }
    ...
    Popup {
        ...
        contentItem: ColumnLayout { spacing: 12
                ...
                Column { spacing: 5
                    ...
                    Rectangle { id: credTypeSel; property string value: "SSH"
                        ...
                        Row { anchors.left: parent.left; anchors.leftMargin: 10; anchors.verticalCenter: parent.verticalCenter; spacing: 6
                            Text { text: "🔐"; font.pixelSize: 13 } Text { text: credTypeSel.value; color: cText; font.pixelSize: 13 } }
            ...
            Column { Layout.fillWidth: true; Layout.leftMargin: 22; Layout.rightMargin: 22; spacing: 5
                Text { text: "Emoji"; color: cDim; font.pixelSize: 11 }
                Rectangle { implicitWidth: emr.implicitWidth + 18; implicitHeight: 36; radius: 8; color: emm.containsMouse ? "#2A2A36" : "#23232C"
                    Row { id: emr; anchors.centerIn: parent; spacing: 8; Text { text: win.credEmoji; font.pixelSize: 17 } Text { text: "Trocar"; color: cText; font.pixelSize: 13 } }
                    MouseArea { id: emm; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                        onClicked: { var i = win.emojiChoices.indexOf(win.credEmoji); win.credEmoji = win.emojiChoices[(i + 1) % win.emojiChoices.length] } } }
            }
            ...
            Column { Layout.fillWidth: true; Layout.leftMargin: 22; Layout.rightMargin: 22; spacing: 6
                Repeater { model: dlgFields
                    delegate: RowLayout { id: fieldRow
                        ...
                        Rectangle { implicitWidth: 30; implicitHeight: 30; radius: 6; color: evm.containsMouse ? "#2A2A36" : "transparent"
                            Text { anchors.centerIn: parent; text: fieldRow.revealed ? "🙈" : "👁"; font.pixelSize: 13 }
                        ...
                        Rectangle { implicitWidth: 30; implicitHeight: 30; radius: 6; color: rmm.containsMouse ? "#43232A" : "transparent"
                            Text { anchors.centerIn: parent; text: "⊖"; color: rmm.containsMouse ? "#FF6A78" : cDim; font.pixelSize: 15 }
